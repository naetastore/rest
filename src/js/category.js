$(function () {
    ...
    let initialaction = `${baseurl}administrator/addcategory?${requiredparams}`;
    let currentaction = '';
    ...
    $(document).on('click', function (e) {
        ...
        if (e.target.classList.contains('js-view')) {
            ...
            const action = `${baseurl}administrator/updatecategory?id=${id}&${requiredparams}`;
            ...
            $.ajax({
                url: `${baseurl}administrator/showcategory?id=${id}&${requiredparams}`,
                method: 'get',
                dataType: 'json',
                success: res => {
                    $('#name').val(res.name);
        ...
        if (e.target.classList.contains('js-remove')) {
            ...
            $.ajax({
                url: `${baseurl}administrator/removecategory?id=${id}&${requiredparams}`,
                method: 'get',
                success: () => {
                    $('.js-cancel').click();
