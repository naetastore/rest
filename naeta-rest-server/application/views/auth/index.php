			...
			<div class="col-xl-10 col-lg-12 col-md-9">
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="card-body p-0">
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block bg-login-image p-4">
								<img src="<?= base_url('src/img/logo.svg'); ?>" alt="logo" class="img-responsive">
								<div class="h3 mt-3">JASA PEMBUATAN<br>WEBSITE</div>
								<br>
								<div>HARGA MULAI DARI</div>
								<div class="_nr mt-2">
									<span class="_wf">Rp.</span>
									 3.000.000,-
								</div>
								<br>
								<p>INCLUDE DOMAIN + HOSTING</p>
								<a class="mb-3" target="_blank" href="https://api.whatsapp.com/send?phone=<?= $telp; ?>">WhatsApp. <?= $telp; ?></a>
							</div>
			  				<div class="col-lg-6">
							  	<div class="p-5">
