...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Enter web application url here" required autocomplete="off" type="text" id="web_app" name="web_app" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?= base_url('src/js/webclient.js'); ?>"></script>
