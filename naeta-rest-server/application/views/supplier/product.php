...
<body>
                    ...
                    <table id="datatable2" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width:80px"><strong>SELLED</strong></th>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <?php else:?>
                            <input type="text" style="display: none" value="<?= $category['id'] . ',' . $category['global_id']; ?>" id="category" name="category" />
                            <?php endif;?>
    ...
    <script src="<?= base_url('src/') ?>js/demo/demo-datatable.js"></script>

    <script src="<?= base_url('src/js/product.js'); ?>"></script>
